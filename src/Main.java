...
public class Main {
    ...
    public static void main(String[] args) {
        com.tecnm.morelia.itics.poo.AnnetJME.Refugiodeanimales.Animal obj1 = new com.tecnm.morelia.itics.poo.AnnetJME.Refugiodeanimales.Animal("Perroo", 25, "Husky", 1.50, 2, 4, "Rino" );
        obj1.capturardatos();
        obj1.mostrar();
